...
-- CreateIndex
CREATE UNIQUE INDEX "Attendance_userId_scheduleId_date_key" ON "Attendance"("userId", "scheduleId", "date");
...
-- AddForeignKey
ALTER TABLE "Assignment" ADD CONSTRAINT "Assignment_instructorId_fkey" FOREIGN KEY ("instructorId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

...
export default function AdminSchedules() {
  ...
  const filterSchedules = () => {
    ...
    filtered.sort((a, b) => {
      const dayCompare = (dayOrder[a.dayOfWeek as keyof typeof dayOrder] || 8) - (dayOrder[b.dayOfWeek as keyof typeof dayOrder] || 8)
  ...
  const openEditModal = (schedule: Schedule) => {
    ...
    setFormData({
      ...
      days: [schedule.dayOfWeek], // Convert single day to array

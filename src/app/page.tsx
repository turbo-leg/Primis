          ...
          <div className={`transition-all duration-2000 delay-500 ${visibleSections.has('hero') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              <button 
                ...
                className="group bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white px-12 py-6 rounded-3xl text-xl font-bold transition-all duration-500 transform hover:scale-110 hover:shadow-2xl shadow-lg"
              >
